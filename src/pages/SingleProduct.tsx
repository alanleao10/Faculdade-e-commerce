...
const SingleProduct = () => {
  ...
  // definindo valores padrão para campos de entrada
      ...
      <div className="grid grid-cols-3 gap-x-8 max-lg:grid-cols-1">
        ...
        <div className="w-full flex flex-col gap-5 mt-9">
          ...
          <div className="flex flex-col gap-3">
            <Button mode="brown" text="Adicionar ao carrinho" onClick={handleAddToCart} />
            <p className="text-secondaryBrown text-sm text-right">
            Entrega estimada para sexta-feira, 26 de julho
            </p>
          </div>
          <div>
            {/* itens suspensos */}
            <Dropdown dropdownTitle="Descrição">
            ...
            <Dropdown dropdownTitle="Detalhes do produto">
            ...
            <Dropdown dropdownTitle="Detalhes da entrega">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga ad
              at odio illo, necessitatibus, reprehenderit dolore voluptas ea
              consequuntur ducimus repellat soluta mollitia facere sapiente.
              Unde provident possimus hic dolore.
